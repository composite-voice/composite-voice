...
cp examples/20-deepgram-pipeline/sample.env examples/20-deepgram-pipeline/.env
```
...
```bash
pnpm example:20-deepgram-pipeline:dev
```

Open [http://localhost:3020](http://localhost:3020) in any modern browser — Chrome, Edge, or Firefox.
