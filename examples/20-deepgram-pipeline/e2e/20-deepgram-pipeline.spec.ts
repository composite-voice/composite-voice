/**
 * E2E test for example 20-deepgram-pipeline.
 *
...
const EXAMPLE_NAME = '20-deepgram-pipeline';
...
test.describe('20-deepgram-pipeline E2E', () => {
  test('page renders without console errors and key UI elements present', async () => {
    ...
    // Check title
    await expect(page).toHaveTitle(/20.*Deepgram.*Pipeline/i);
