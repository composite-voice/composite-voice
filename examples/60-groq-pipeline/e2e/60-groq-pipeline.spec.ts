/**
 * E2E test for example 60-groq-pipeline.
 *
 * Provider stack: DeepgramSTT (nova-3) + GroqLLM (llama-3.3-70b-versatile) + DeepgramTTS (aura-2-thalia-en)
 *
 ...
 *
 * Required environment variables: DEEPGRAM_API_KEY, GROQ_API_KEY
 */
...
const EXAMPLE_NAME = '60-groq-pipeline';
...
test.describe('60-groq-pipeline E2E', () => {
  test('page renders without console errors and key UI elements present', async () => {
    ...
    // Check title
    await expect(page).toHaveTitle(/60.*Groq.*Pipeline/i);
