    ...
    const agent = new CompositeVoice({
      providers: [
        ...
        new AnthropicLLM({
          ...
          systemPrompt: `You are a helpful voice assistant. The user is speaking in ${langLabel}. Respond in the same language (${langLabel}). Keep responses to two or three sentences.`,
          maxTokens: 200,
        }),
