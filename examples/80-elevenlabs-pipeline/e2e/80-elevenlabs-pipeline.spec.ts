/**
 * E2E test for example 80-elevenlabs-pipeline.
 *
 * Provider stack: DeepgramSTT (nova-3) + AnthropicLLM (claude-sonnet) + ElevenLabsTTS (eleven_turbo_v2_5)
 *
 ...
 *
 * Required environment variables: DEEPGRAM_API_KEY, ANTHROPIC_API_KEY, ELEVENLABS_API_KEY
 */
...
const EXAMPLE_NAME = '80-elevenlabs-pipeline';
...
test.describe('80-elevenlabs-pipeline E2E', () => {
  test('page renders without console errors and key UI elements present', async () => {
    ...
    // Check title
    await expect(page).toHaveTitle(/80.*ElevenLabs.*Pipeline/i);
