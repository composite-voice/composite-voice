...
export function BrandIcon({ size = "md", label, className }: SharedIconProps) {
  ...
  return (
    ...
    >
      <path
        d="M36.7 93.8L36.7 93.8Q29.0 93.8 22.9 90.3Q16.7 86.8 13.2 80.1Q9.7 73.4 9.7 63.9L9.7 63.9Q9.7 54.4 13.2 47.7Q16.8 41.0 22.9 37.5Q29.0 34.0 36.7 34.0L36.7 34.0Q41.7 34.0 45.9 35.4Q50.2 36.8 53.5 39.4Q56.9 42.1 59.0 45.9Q61.1 49.8 61.7 54.7L61.7 54.7L49.7 54.7Q49.3 52.3 48.2 50.4Q47.1 48.6 45.4 47.3Q43.7 46.0 41.6 45.3Q39.4 44.6 36.9 44.6L36.9 44.6Q32.4 44.6 29.0 46.9Q25.6 49.1 23.7 53.4Q21.8 57.8 21.8 63.9L21.8 63.9Q21.8 70.2 23.7 74.5Q25.6 78.8 29.0 81.0Q32.4 83.2 36.9 83.2L36.9 83.2Q39.4 83.2 41.5 82.5Q43.7 81.8 45.4 80.5Q47.1 79.2 48.2 77.3Q49.3 75.5 49.7 73.1L49.7 73.1L61.8 73.1Q61.3 77.1 59.4 80.9Q57.4 84.6 54.2 87.5Q51.0 90.4 46.6 92.1Q42.2 93.8 36.7 93.8Z"
        fill="currentColor"
      />
      <path
        d="M101.9 93L86.3 93L65.9 34.8L79.2 34.8L88.5 62.9Q90.1 68.2 91.9 74.6L91.9 74.6Q93.0 78.7 94.2 83.4L94.2 83.4Q95.4 78.7 96.4 74.5L96.4 74.5Q98.1 68.2 99.7 62.9L99.7 62.9L108.6 34.8L121.8 34.8L101.9 93Z"
